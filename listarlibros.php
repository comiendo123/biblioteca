	...
	if ($num_filas > 0) {
		...
		while ($fila = mysqli_fetch_array($resultado)) {
			echo "<tr>";
				...
				echo "<td><img height='250' width='200' src='data:image/jpg;base64," .base64_encode($fila['Portada']) ."'/></td>";

				echo "<td>
					<strong><p style='color:black;'>Titulo: </p></strong><h2>" .$fila['Titulo'] ."</h2><br><br>
					<strong><p style='color:black;'>Autor: </p></strong><h2>"  .$fila['Autor'] ."</h2><br><br>
					<strong><p style='color:black;'>Género: </p></strong><h2>" .$fila['Genero'] ."</h2><br><br>
					<strong><p style='color:black;'>Editorial: </p></strong><h2>" .$fila['Editorial'];
				echo "</h2></td>";
